<x-app-layout>
  ...
  <div class="container w-full md:max-w-3xl mx-auto pt-20">
    ...
    <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal jus" style="font-family:Georgia,serif;">
      ...
      <div class="font-sans">
        ...
        <p class="text-sm md:text-base font-normal text-gray-600">Published {{ $blog?->created_at->format( 'd M, Y')}}</p>
      </div>
